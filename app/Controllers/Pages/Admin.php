...
class Admin extends BaseController
{
    ...
    public function invoices(): void
    {
        ...
        foreach ($clients as $client) {
            ...
            if ($key === false || (isset($previous_readings[$key]) && $previous_readings[$key] === 0)) {
                $previous_readings[$client['id']] = floatval($client['counter_initial']);
            }
        }
    ...
    public function receipts(): void
    {
        ...
        $clients_id_haystack = array_column($clients, "id");
