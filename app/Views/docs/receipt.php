...
<div class="container-fluid">
    <div class="row">
        <div class="col">
            ...
            <h5 class="px-5 font-weight-bold">NUIT: 300020607</h5>
        </div>
        <div class="col-auto">
            <p>Tel: +258 846099218</p>
            <p>Morada: Av de Moçambique nr 11, Maputo</p>
            <p>Email: aguasaz68@gmail.com</p>
    ...
    <div class="row pt-5">
        <div class="col">
            ...
            <h5><b>Nome:</b> <?= $client->name . " ". $client->surname  ?></h5>
        ...
        <div class="col-auto text-right">
            ...
            <h5><b>Leitura/Consumo:</b> <?= $invoice->counter ?>/<?= $invoice->consumption ?> m3</h5>
        </div>
    </div>
