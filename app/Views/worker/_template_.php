...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand mt-4 d-flex align-items-center justify-content-center"
           href="<?= $router->route("admin.home") ?>">
            <div class="sidebar-brand-text">
                <img src="<?= assets("img/SGFA.png") ?>" height="140px" width="220px">
            </div>
        </a>
        ...
        <li class="nav-item active">
            <a class="nav-link" href="<?= $router->route("worker.invoices") ?>">
        ...
        <hr class="sidebar-divider my-0">
        <li class="nav-item active">
            <a class="nav-link" href="<?= $router->route("worker.receipts") ?>">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="<?= $router->route("worker.clients") ?>">
                <i style="font-size: 1rem" class="fas fa-fw fa-users"></i>
                <span style="font-size: 1rem">Clientes</span></a>
        </li>
        <hr class="sidebar-divider my-0">
        <li class="nav-item active">
            <a class="nav-link" href="<?= $router->route("worker.sms") ?>">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="<?= $router->route("worker.config") ?>">
